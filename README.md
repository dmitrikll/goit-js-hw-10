...
Використовуй публічний API [**Rest Countries v2**](https://restcountries.com/),
а саме [**ресурс name**](https://restcountries.com/#api-endpoints-v3-name), який
...
використовуй
[**бібліотеку notiflix**](https://github.com/notiflix/Notiflix#readme) і виводь
такий рядок `"Too many matches found. Please enter a more specific name."`.
